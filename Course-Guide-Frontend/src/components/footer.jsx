            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget subscribe no-box">
                  ...
                  <p>
                    Created by: Jillian Biasotti, <br />
                    Joe Ruiz, and Aden Mariyappa{" "}
                  </p>
                </div>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-3">
                  ...
                  <ul className="thumbnail-widget">
                    <li>
                      <div className="thumb-content">
                        <a href="https://www.qu.edu">Quinnipiac University</a>
                      </div>
                    </li>
                    <li>
                      <div className="thumb-content">
                        <a href="https://www.qu.edu/student-resources/directory.html">
                          Quinnipiac Directory
                        </a>
                      </div>
                    </li>
                    <li>
                      <div className="thumb-content">
                        <a href="https://quinnipiac-csm.symplicity.com/students/?signin_tab=0">
                          QUCC
                        </a>
                      </div>
                    </li>
                    <li>
                      <div className="thumb-content">
                        <a href="https://myq.quinnipiac.edu/undergraduate/Pages/default.aspx">
                          MyQ
                        </a>
                      </div>
                    </li>
              ...
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget no-box">
                  ...
                  <p>Leave information and questions here.</p>
                  <a
                    className="btn"
                    href="#."
              ...
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget no-box">
                  ...
                  <p>
                    <a href="mailto:help@qu.edu" title="glorythemes">
                      help@qu.edu
                    </a>
                  </p>
                  <ul className="social-footer2">
                    <li className>
                      <a
                        title="youtube"
                        target="_blank"
                        href="https://www.youtube.com/user/QuinnipiacUniversity"
                      >
                        <img
                          alt="youtube"
                          width={30}
                    ...
                    <li className>
                      <a
                        href="https://www.facebook.com/QuinnipiacUniversity/"
                        target="_blank"
                        title="Facebook"
                      >
                        <img
                    ...
                    <li className>
                      <a
                        href="https://twitter.com/QuinnipiacU?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"
                        target="_blank"
                        title="Twitter"
                      >
                        <img
                    ...
                    <li className>
                      <a
                        title="instagram"
                        target="_blank"
                        href="https://www.instagram.com/quinnipiacu/?hl=en"
                      >
                        <img
                          alt="instagram"
                          width={30}
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <p>Copyright Course Guide © 2019. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
